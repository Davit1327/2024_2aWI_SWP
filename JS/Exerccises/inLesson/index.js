...
let numbers = [1, 2, 3, 4, 5, 66, 77]    //// Array of numbers

console.log("index 0:", numbers[0]) //1
console.log("index 1:", numbers[1]) //2
console.log("index 2:", numbers[2]) //3
console.log("index 3:", numbers[3]) //4

// String
let text = "Hello World!"
console.log("index 0:", text[0]) //1
console.log("index 1:", text[1]) //2
console.log("index 2:", text[2]) //3
console.log("index 3:", text[3]) //4
